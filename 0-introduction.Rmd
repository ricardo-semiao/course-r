...
:::{.warn}
nesse bloco explicíto coisas que o leitor deve prestar atenção. Na maioria dos casos, apresento causas comuns de erros.
:::
...
:::{.extra}
vide [@workr], capítulo "3 - Using RStudio", e/ou [@cookr], [3 - "Navigatin the Software"](https://rc2e.com/navigatingthesoftware), para mais informações sobre a interface.
:::
