...
- **Inteiros positivos:** retornam elementos nas posições
  ...
  - Obs2: factors são tratados como intergers\pause
...
- Podemos reassinalar mais de um elemento por vez\pause
...
- **Vetore lógico** com `TRUE` nos índices dos elementos quistos
- **Vetore de texto** com os nomes dos elementos quistos
